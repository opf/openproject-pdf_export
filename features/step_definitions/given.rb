...
Given /^there are multiple export card configurations$/ do
  config1 = ExportCardConfiguration.create!(name: 'Default',
                                            ...
                                            rows: "group1:\n  has_border: false\n  rows:\n    row1:\n      height: 50\n      priority: 1\n      columns:\n        id:\n          has_label: false")
  config2 = ExportCardConfiguration.create!(name: 'Custom',
                                            description: 'This is a description',
                                            active: true,
                                            per_page: 1,
                                            page_size: 'A4',
                                            orientation: 'landscape',
                                            rows: "group1:\n  has_border: false\n  rows:\n    row1:\n      height: 50\n      priority: 1\n      columns:\n        id:\n          has_label: false")
  config3 = ExportCardConfiguration.create!(name: 'Custom 2',
                                            description: 'This is a description',
                                            active: true,
                                            per_page: 1,
                                            page_size: 'A4',
                                            orientation: 'landscape',
                                            rows: "group1:\n  has_border: false\n  rows:\n    row1:\n      height: 50\n      priority: 1\n      columns:\n        id:\n          has_label: false")
  config4 = ExportCardConfiguration.create!(name: 'Custom Inactive',
                                            description: 'This is a description',
                                            active: false,
                                            per_page: 1,
                                            page_size: 'A4',
